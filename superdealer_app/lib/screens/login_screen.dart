        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Sign in to manage orders and activations',
                  style: TextStyle(
                      fontSize: 15,
              ...
              _buildField('Email Address', 'dealer@supergps.com',
                  Icons.email_outlined, _emailCtrl,
                  keyboardType: TextInputType.emailAddress),
              const SizedBox(height: 16),
              _buildField('Password', 'Enter your password', Icons.lock_outline,
                  _passCtrl,
