...
const { getMyVehicles, getVehicleById, getDealerVehicles, getAllVehicles, createVehicle, updateVehicle, deleteVehicle } = require('../controllers/vehicleController');
...
router.post('/', protect, authorize('admin'), createVehicleRules, createVehicle);
